...
from .jumia import scrape_jumia_products
...
@api_view(['GET'])
def get_all_outside(request):
    # scrraping
    query = request.GET.get('keyword', '')  # Assuming the search query is passed as a GET parameter named 'query'
